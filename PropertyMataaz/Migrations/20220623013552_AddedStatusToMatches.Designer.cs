...
namespace PropertyMataaz.Migrations
{
    ...
    [Migration("20220623013552_AddedStatusToMatches")]
    partial class AddedStatusToMatches
    {
            ...
            modelBuilder.Entity("PropertyMataaz.Models.User", b =>
                {
                    ...
                    b.Property<DateTime>("DateCreated")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("timestamp without time zone")
                        .HasDefaultValue(new DateTime(2022, 6, 23, 2, 35, 51, 828, DateTimeKind.Local).AddTicks(2290));

                    b.Property<DateTime>("DateModified")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("timestamp without time zone")
                        .HasDefaultValue(new DateTime(2022, 6, 23, 2, 35, 51, 835, DateTimeKind.Local).AddTicks(7320));
