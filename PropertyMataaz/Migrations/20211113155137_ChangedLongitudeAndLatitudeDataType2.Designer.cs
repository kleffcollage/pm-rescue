...
namespace PropertyMataaz.Migrations
{
    ...
    [Migration("20211113155137_ChangedLongitudeAndLatitudeDataType2")]
    partial class ChangedLongitudeAndLatitudeDataType2
    {
            ...
            modelBuilder.Entity("PropertyMataaz.Models.User", b =>
                {
                    ...
                    b.Property<DateTime>("DateCreated")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("timestamp without time zone")
                        .HasDefaultValue(new DateTime(2021, 11, 13, 16, 51, 37, 92, DateTimeKind.Local).AddTicks(2550));

                    b.Property<DateTime>("DateModified")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("timestamp without time zone")
                        .HasDefaultValue(new DateTime(2021, 11, 13, 16, 51, 37, 101, DateTimeKind.Local).AddTicks(8250));
