...
namespace PropertyMataaz.Migrations
{
    ...
    [Migration("20211207203008_AddAlternativePhoneNumber")]
    partial class AddAlternativePhoneNumber
    {
            ...
            modelBuilder.Entity("PropertyMataaz.Models.User", b =>
                {
                    ...
                    b.Property<DateTime>("DateCreated")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("timestamp without time zone")
                        .HasDefaultValue(new DateTime(2021, 12, 7, 21, 30, 7, 518, DateTimeKind.Local).AddTicks(6320));

                    b.Property<DateTime>("DateModified")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("timestamp without time zone")
                        .HasDefaultValue(new DateTime(2021, 12, 7, 21, 30, 7, 530, DateTimeKind.Local).AddTicks(8320));
