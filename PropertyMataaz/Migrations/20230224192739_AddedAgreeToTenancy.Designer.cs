...
namespace PropertyMataaz.Migrations
{
    ...
    [Migration("20230224192739_AddedAgreeToTenancy")]
    partial class AddedAgreeToTenancy
    {
            ...
            modelBuilder.Entity("PropertyMataaz.Models.User", b =>
                {
                    ...
                    b.Property<DateTime>("DateCreated")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("timestamp without time zone")
                        .HasDefaultValue(new DateTime(2023, 2, 24, 20, 27, 32, 875, DateTimeKind.Local).AddTicks(7970));

                    b.Property<DateTime>("DateModified")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("timestamp without time zone")
                        .HasDefaultValue(new DateTime(2023, 2, 24, 20, 27, 32, 882, DateTimeKind.Local).AddTicks(7550));
