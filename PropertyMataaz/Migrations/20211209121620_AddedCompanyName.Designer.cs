...
namespace PropertyMataaz.Migrations
{
    ...
    [Migration("20211209121620_AddedCompanyName")]
            ...
            modelBuilder.Entity("PropertyMataaz.Models.User", b =>
                {
                    ...
                    b.Property<DateTime>("DateCreated")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("timestamp without time zone")
                        .HasDefaultValue(new DateTime(2021, 12, 9, 13, 16, 19, 260, DateTimeKind.Local).AddTicks(1570));

                    b.Property<DateTime>("DateModified")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("timestamp without time zone")
                        .HasDefaultValue(new DateTime(2021, 12, 9, 13, 16, 19, 277, DateTimeKind.Local).AddTicks(2010));
