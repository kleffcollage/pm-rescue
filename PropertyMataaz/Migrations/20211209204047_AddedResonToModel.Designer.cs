...
namespace PropertyMataaz.Migrations
{
    ...
    [Migration("20211209204047_AddedResonToModel")]
    partial class AddedResonToModel
    {
            ...
            modelBuilder.Entity("PropertyMataaz.Models.User", b =>
                {
                    ...
                    b.Property<DateTime>("DateCreated")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("timestamp without time zone")
                        .HasDefaultValue(new DateTime(2021, 12, 9, 21, 40, 46, 727, DateTimeKind.Local).AddTicks(1270));

                    b.Property<DateTime>("DateModified")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("timestamp without time zone")
                        .HasDefaultValue(new DateTime(2021, 12, 9, 21, 40, 46, 736, DateTimeKind.Local).AddTicks(5660));
