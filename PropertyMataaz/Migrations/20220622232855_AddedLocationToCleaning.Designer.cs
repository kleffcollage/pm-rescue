...
namespace PropertyMataaz.Migrations
{
    ...
    [Migration("20220622232855_AddedLocationToCleaning")]
    partial class AddedLocationToCleaning
    {
            ...
            modelBuilder.Entity("PropertyMataaz.Models.User", b =>
                {
                    ...
                    b.Property<DateTime>("DateCreated")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("timestamp without time zone")
                        .HasDefaultValue(new DateTime(2022, 6, 23, 0, 28, 54, 955, DateTimeKind.Local).AddTicks(4640));

                    b.Property<DateTime>("DateModified")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("timestamp without time zone")
                        .HasDefaultValue(new DateTime(2022, 6, 23, 0, 28, 54, 962, DateTimeKind.Local).AddTicks(8890));
