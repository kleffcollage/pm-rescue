...
namespace PropertyMataaz.Migrations
{
    ...
    [Migration("20230220202223_AddedDocumentToPropertyModel")]
    partial class AddedDocumentToPropertyModel
    {
            ...
            modelBuilder.Entity("PropertyMataaz.Models.User", b =>
                {
                    ...
                    b.Property<DateTime>("DateCreated")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("timestamp without time zone")
                        .HasDefaultValue(new DateTime(2023, 2, 20, 21, 22, 13, 963, DateTimeKind.Local).AddTicks(230));

                    b.Property<DateTime>("DateModified")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("timestamp without time zone")
                        .HasDefaultValue(new DateTime(2023, 2, 20, 21, 22, 13, 977, DateTimeKind.Local).AddTicks(2230));
