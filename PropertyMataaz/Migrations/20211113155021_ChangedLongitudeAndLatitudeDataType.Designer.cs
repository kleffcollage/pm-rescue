...
namespace PropertyMataaz.Migrations
{
    ...
    [Migration("20211113155021_ChangedLongitudeAndLatitudeDataType")]
    partial class ChangedLongitudeAndLatitudeDataType
    {
            ...
            modelBuilder.Entity("PropertyMataaz.Models.User", b =>
                {
                    ...
                    b.Property<DateTime>("DateCreated")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("timestamp without time zone")
                        .HasDefaultValue(new DateTime(2021, 11, 13, 16, 50, 20, 460, DateTimeKind.Local).AddTicks(4820));

                    b.Property<DateTime>("DateModified")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("timestamp without time zone")
                        .HasDefaultValue(new DateTime(2021, 11, 13, 16, 50, 20, 468, DateTimeKind.Local).AddTicks(8770));
