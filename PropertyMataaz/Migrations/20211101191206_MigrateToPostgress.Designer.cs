...
namespace PropertyMataaz.Migrations
{
    ...
    [Migration("20211101191206_MigrateToPostgress")]
            ...
            modelBuilder.Entity("PropertyMataaz.Models.User", b =>
                {
                    ...
                    b.Property<DateTime>("DateCreated")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("timestamp without time zone")
                        .HasDefaultValue(new DateTime(2021, 11, 1, 20, 12, 6, 133, DateTimeKind.Local).AddTicks(6290));

                    b.Property<DateTime>("DateModified")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("timestamp without time zone")
                        .HasDefaultValue(new DateTime(2021, 11, 1, 20, 12, 6, 142, DateTimeKind.Local).AddTicks(9010));
