...
namespace PropertyMataaz.Migrations
{
    ...
    [Migration("20211209204921_AddedRenewable")]
    partial class AddedRenewable
    {
            ...
            modelBuilder.Entity("PropertyMataaz.Models.User", b =>
                {
                    ...
                    b.Property<DateTime>("DateCreated")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("timestamp without time zone")
                        .HasDefaultValue(new DateTime(2021, 12, 9, 21, 49, 21, 268, DateTimeKind.Local).AddTicks(6970));

                    b.Property<DateTime>("DateModified")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("timestamp without time zone")
                        .HasDefaultValue(new DateTime(2021, 12, 9, 21, 49, 21, 278, DateTimeKind.Local).AddTicks(2680));
