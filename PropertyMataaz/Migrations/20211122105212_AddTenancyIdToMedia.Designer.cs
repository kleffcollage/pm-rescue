...
namespace PropertyMataaz.Migrations
{
    ...
    [Migration("20211122105212_AddTenancyIdToMedia")]
    partial class AddTenancyIdToMedia
    {
            ...
            modelBuilder.Entity("PropertyMataaz.Models.User", b =>
                {
                    ...
                    b.Property<DateTime>("DateCreated")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("timestamp without time zone")
                        .HasDefaultValue(new DateTime(2021, 11, 22, 11, 52, 12, 54, DateTimeKind.Local).AddTicks(6540));

                    b.Property<DateTime>("DateModified")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("timestamp without time zone")
                        .HasDefaultValue(new DateTime(2021, 11, 22, 11, 52, 12, 62, DateTimeKind.Local).AddTicks(4170));
