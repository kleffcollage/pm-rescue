...
namespace PropertyMataaz.Migrations
{
    ...
    [Migration("20230220195811_ChangedTypeOfDescription")]
    partial class ChangedTypeOfDescription
    {
            ...
            modelBuilder.Entity("PropertyMataaz.Models.User", b =>
                {
                    ...
                    b.Property<DateTime>("DateCreated")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("timestamp without time zone")
                        .HasDefaultValue(new DateTime(2023, 2, 20, 20, 58, 4, 766, DateTimeKind.Local).AddTicks(9910));

                    b.Property<DateTime>("DateModified")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("timestamp without time zone")
                        .HasDefaultValue(new DateTime(2023, 2, 20, 20, 58, 4, 776, DateTimeKind.Local).AddTicks(1510));
